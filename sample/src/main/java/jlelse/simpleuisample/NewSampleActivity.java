...
import jlelse.simpleui.NewSimpleActivity;
import jlelse.simpleui.SimpleDialog;

public class NewSampleActivity extends NewSimpleActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setDrawerListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                new SimpleDialog(NewSampleActivity.this).SimpleOKDialog("Test", "Hey!");
